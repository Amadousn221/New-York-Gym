...
const translations: Record<Lang, Translations> = {
  ...
  fr: {
    ...
    hero: {
      srText: "Nous sommes tous forts sur cette planète™. Rejoignez le club aujourd'hui!",
      searchPlaceholder: "Rechercher par adresse, ville ou code postal",
      findAClub: "Trouver un club",
    },
    memberships: {
      heading: "Adhésions",
      description:
        "Nous proposons l'adhésion NY Gym Black Card® et l'adhésion Classique. Les deux vous donnent accès à La Zone Sans Jugement®, ainsi qu'à des tonnes d'équipements cardio et de musculation.",
      blackCard: "NY GYM BLACK CARD®",
      bestValue: "Meilleur rapport qualité-prix",
      startingAt: "À partir de",
      perMonth: "/mois*",
      taxesFees: "plus taxes et frais",
      blackCardDesc:
        "Accès à n'importe quel club, amenez un invité à tout moment, séances d'entraînement numériques premium NY Gym+, et bien plus encore!",
      learnMore: "En savoir plus",
      joinNow: "Rejoindre",
      classic: "CLASSIQUE",
      classicDesc: "Notre adhésion standard, avec accès illimité à votre club d'origine.",
      compare: "Comparer les adhésions",
    },
    whyPF: {
      prefix: "un endroit où",
      highlight: "tout le monde",
      suffix: "se sent bienvenu",
      bestValueTitle: "Le meilleur rapport qualité-prix sur la planète",
      bestValueDesc:
        "Nous croyons en la prestation d'une expérience de haute qualité à un coût abordable.",
      equipmentTitle: "Tonnes d'équipements",
      equipmentDesc:
        "Des tonnes d'équipements cardio et de musculation, dans un environnement propre et spacieux.",
      locationsTitle: "2 700+ clubs",
      locationsDesc: "Plus de 2 700 clubs New York Gym dans le monde entier.",
      learnMore: "En savoir plus",
    },
    pfApp: {
      prefix: "Emportez la",
      highlight: "Zone Sans Jugement®",
      suffix: "partout",
      description:
        "L'application NY Gym a tout — choisissez le meilleur moment pour visiter votre club avec le compteur de fréquentation, suivez vos activités, accédez à des centaines de séances d'entraînement numériques à la demande, et plus encore! Prêt à bouger?",
      cta: "Télécharger l'application NY Gym",
    },
    getStarted: {
      heading: "Commencez aujourd'hui",
      findClub: "Trouver un club près de chez vous",
      explorePerks: "Explorer les avantages",
      virtualTour: "Visite virtuelle",
      disclaimer:
        "*Les adhésions Classiques débutent à 15 $ et les adhésions NY Gym Black Card® débutent à 24,99 $, facturées mensuellement. Les adhésions peuvent inclure un engagement de 12 mois. Les taxes locales et d'État peuvent s'appliquer. Soumis à des frais annuels de 49 $. Les prix peuvent varier selon l'emplacement. Services et avantages sous réserve de disponibilité et de restrictions. Doit avoir au moins 18 ans pour s'inscrire, ou 13-17 ans avec un parent/tuteur. Les restrictions d'État et locales sur la fréquence de bronzage avec les adhésions NY Gym Black Card® s'appliquent. Établissements participants uniquement. Établissements indépendants et exploités de manière indépendante. Voir le club d'origine pour plus de détails. Nous nous réservons le droit de corriger les erreurs de prix ou de retirer l'offre à tout moment. ©2026 New York Gym Franchising LLC",
    },
    footer: {
      downloadApp: "Télécharger l'application NY Gym",
      infoHeading: "Infos",
      ...
      privacyRights: "Vos droits à la vie privée",
    ...
    services: [
      {
        ...
        description:
          "Vous ne savez pas par où commencer? Nos programmes vous guident étape par étape, de votre première séance à votre plus forte. Conçus pour tous les niveaux, tous les objectifs, tous les horaires. Pas de devinettes, pas d'intimidation. Présentez-vous et suivez le plan.",
      ...
      },
      {
        ...
        description:
          "S'entraîner avec d'autres vous pousse plus loin que vous n'iriez seul. Rejoignez n'importe quel cours, n'importe quel jour, sans réservation nécessaire. Du cyclisme à la musculation, chaque séance est animée par un instructeur. Venez une fois. Vous reviendrez.",
        ctaLabel: "Voir les cours",
        ctaHref: "/group-fitness",
        image: "/images/about-pf/exercise-bike.webp",
        imageAlt: "Cours de fitness en groupe chez New York Gym",
      },
      {
        title: "Entraînements à la demande",
        description:
          "Vous ne pouvez pas venir au club? Pas de problème. Des centaines de cours vous attendent dans l'application NY Gym. Cardio, musculation, étirements et plus encore, animés par de vrais entraîneurs. Entraînez-vous à la maison ou en déplacement. Votre horaire, vos règles.",
        ctaLabel: "Voir à la demande",
        ctaHref: "/on-demand",
        image: "/images/why-pf/pf-app.webp",
      ...
      },
      {
        ...
        description:
          "Vous avez pris l'habitude. Il est temps d'aller plus loin. Nos programmes de performance sont conçus pour les membres qui veulent s'entraîner avec un objectif précis: un 5 km, un triathlon ou un nouveau record personnel. Dépassez vos limites avec un plan structuré.",
        ctaLabel: "Calendrier des cours",
        ctaHref: "/class-schedule",
        image: "/images/our-clubs/fitness-training.webp",
    ...
    carousel2: [
      {
        title: "NOUVEAU! Guides d'entraînement dans l'application NY Gym",
        description:
          "Vous voulez un guide facile à suivre qui vous accompagne à travers les séries et répétitions étape par étape? On vous couvre! En prime: chaque exercice inclut un tutoriel visuel pour vous guider sur la bonne forme.",
      ...
      {
        title: "BOOSTEZ-VOUS AVEC DES AVANTAGES EXCLUSIFS",
        description:
          "Économisez gros sur vos marques préférées grâce à des réductions exclusives et des offres spéciales.",
        ctaLabel: "Explorer les avantages",
        ctaHref: "/my-account/perks",
        image: "/images/carousel2-slide2-perks.webp",
        imageAlt: "Explorer les avantages",
      },
      {
        title: "Gagnez des mois gratuits en parrainant vos amis",
        description:
          "Vous voulez un partenaire d'entraînement et une bonne affaire en même temps? Chaque ami que vous parrainez vous rapporte un mois gratuit (jusqu'à 3 mois/an)!* En plus, vos amis bénéficient d'une offre à 1 $ sans engagement.",
        ctaLabel: "Parrainer un ami",
        ctaHref: "https://planetfitness.app.link/refer",
        image: "/images/carousel2-slide3-refer-friend.webp",
        imageAlt: "Parrainer un ami",
      },
      {
        title: "OBTENEZ VOTRE ÉQUIPEMENT",
        description:
          "Nous avons tout ce dont vous avez besoin pour commencer votre parcours fitness: sacs, tenues, essentiels de vestiaire et plus encore, le tout à bas prix! Visitez notre boutique.",
